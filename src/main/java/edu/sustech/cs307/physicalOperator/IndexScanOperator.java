...
/**
 * IndexScanOperator uses an in-memory ordered index to scan records.
 * It reads index entries (Value → RID mappings) and fetches the corresponding
...
public class IndexScanOperator implements PhysicalOperator {
    ...
    public IndexScanOperator(DBManager dbManager, String tableName,
