...
/**
 * B+ Tree implementation that supports multi-value range queries.
 * Each key maps to a single value; use searchRange() to collect values across a key range.
 * 
...
public class BPlusTree<K extends Comparable<? super K>, V> {
    ...
    /**
     * Returns all values associated with keys in the range [key1, key2].
     */
    ...
    /**
     * Insert a key-value pair. If key exists, the value is replaced.
     */
    ...
    /**
     * Delete the association for the specified key.
     */
    ...
    public void printTree() {
        ...
        System.out.println("BranchingFactor: " + branchingFactor);
    ...
    private class InternalNode extends Node {
        ...
        @Override
        V getValue(K key) { return getChild(key).getValue(key); }
        ...
        @Override
        K getFirstLeafKey() { return children.get(0).getFirstLeafKey(); }
        ...
        @Override
        boolean isOverflow() { return children.size() > branchingFactor; }

        @Override
        boolean isUnderflow() { return children.size() < (branchingFactor + 1) / 2; }
    ...
    private class LeafNode extends Node {
        ...
        @Override
        K getFirstLeafKey() { return keys.get(0); }
        ...
        @Override
        boolean isOverflow() { return values.size() > branchingFactor - 1; }

        @Override
        boolean isUnderflow() { return values.size() < branchingFactor / 2; }
    }
}